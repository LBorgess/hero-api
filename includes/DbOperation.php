...
/**
 * CLasse com as operações do banco de dados
 */
class DbOperation
{
	...
	/**
	 * Método responsável por criar o herói
	 *
	 * @param  string  $name - Nome do herói
	 * @param  string  $realname - Nome real do herói
	 * @param  integer $rating - Rankeamento do herói
	 * @param  string  $teamaffiliation - Afiliação do herói
	 * @return boolean
	 */
	...
	/**
	 * Método responsável por apagar um registro no banco de dados
	 *
	 * @param integer $id
	 * @return boolean
	 */
